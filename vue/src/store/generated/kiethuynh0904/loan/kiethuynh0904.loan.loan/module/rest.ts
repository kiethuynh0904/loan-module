...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/kiethuynh0904/loan/loan/loan
   */
  queryLoanAll = (
    query?: {
    ...
    this.request<LoanQueryAllLoanResponse, RpcStatus>({
      path: `/kiethuynh0904/loan/loan/loan`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/kiethuynh0904/loan/loan/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<LoanQueryParamsResponse, RpcStatus>({
      path: `/kiethuynh0904/loan/loan/params`,
      method: "GET",
      format: "json",
      ...params,
    });
